...
public class TaskServices {
    ...
    /**
     * Replaces an existing task with a new one, maintaining the original creation date.
     * Since the repository extends the @class CrudRepository, the save() method overwrites entries
     * and so acts as a replace.
     *
     * @param taskId  The UUID of the task to be replaced.
     * @param taskNew The new task.
     * @return Optional containing the updated task, or empty if the original task was not found.
     */
